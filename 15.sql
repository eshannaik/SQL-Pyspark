-- CREATE TABLE google_gmail_emails_15 (id INT PRIMARY KEY,from_user VARCHAR(50),to_user VARCHAR(50),day INT);

-- INSERT INTO google_gmail_emails_15 (id, from_user, to_user, day) VALUES(0, '6edf0be4b2267df1fa', '75d295377a46f83236', 10),(1, '6edf0be4b2267df1fa', '32ded68d89443e808', 6),
...
-- (17, '75d295377a46f83236', '55e60cfcc9dc49c17e', 3),(18, '75d295377a46f83236', '47be2887786891367e', 10),(19, '75d295377a46f83236', '5b8754928306a18b68', 10),(20, '75d295377a46f83236', '850badf89ed8f06854', 7);
WITH f_user as (
	SELECT 
		day,
		COUNT(DISTINCT from_user) as 'count_from',
        COUNT(DISTINCT to_user) as 'count_to' 
	FROM google_gmail_emails_15
	group by day
)
SELECT * FROM google_gmail_emails_15
WHERE day in (
	SELECT CASE WHEN count_from < count_to THEN day ELSE NULL END as 'day'
	FROM f_user f
)
ORDER BY day asc